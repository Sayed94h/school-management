...
The `package copy.json` is the copy of the original `package.json` that contains many many unnecessary dependencies in my opinion. I removed many dependencies from `package.json`.
